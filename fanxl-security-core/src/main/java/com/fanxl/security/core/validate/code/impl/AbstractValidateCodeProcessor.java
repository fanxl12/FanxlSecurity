package com.fanxl.security.core.validate.code.impl;

import com.fanxl.security.core.validate.code.*;
...
//		return (C) validateCodeGenerator.generate(request);
	...
	private void save(ServletWebRequest request, C validateCode) {
		// 这里重新new一遍是因为用了redis来缓存session，图片BufferedImage不能实现Serializable，不能缓存
