package com.fanxl.security.browser.logout;
 ...
 *
 */
public class FanLogoutSuccessHandler implements LogoutSuccessHandler {

	private Logger logger = LoggerFactory.getLogger(getClass());

	public FanLogoutSuccessHandler(String signOutSuccessUrl) {
